...
public class Full________ implements Serializable
{
    ...
    @JsonProperty("w")
    private Long w;
    private final static long serialVersionUID = -3388691367027856438L;
     ...
     * @param h
     */
    public Full________(Long h, Long w) {
        super();
        this.h = h;
        this.w = w;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Full________) == false) {
            return false;
        }
        Full________ rhs = ((Full________) other);

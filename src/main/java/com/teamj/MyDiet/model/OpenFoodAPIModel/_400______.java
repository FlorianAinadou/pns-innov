...
public class _400______ implements Serializable
{
    ...
    @JsonProperty("w")
    private Long w;
    private final static long serialVersionUID = -1146558775414171512L;
     ...
     * @param h
     */
    public _400______(Long h, Long w) {
        super();
        this.h = h;
        this.w = w;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _400______) == false) {
            return false;
        }
        _400______ rhs = ((_400______) other);

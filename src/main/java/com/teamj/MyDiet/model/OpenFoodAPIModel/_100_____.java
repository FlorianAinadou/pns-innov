...
public class _100_____ implements Serializable
{
    ...
    @JsonProperty("h")
    private Long h;
    private final static long serialVersionUID = -6894918938598296036L;
     ...
     * @param h
     */
    public _100_____(Long w, Long h) {
        super();
        this.w = w;
        this.h = h;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _100_____) == false) {
            return false;
        }
        _100_____ rhs = ((_100_____) other);

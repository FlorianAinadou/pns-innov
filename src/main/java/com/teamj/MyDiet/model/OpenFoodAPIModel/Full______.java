...
public class Full______ implements Serializable
{
    ...
    @JsonProperty("w")
    private Long w;
    private final static long serialVersionUID = -6040496052415864059L;
     ...
     * @param h
     */
    public Full______(Long h, Long w) {
        super();
        this.h = h;
        this.w = w;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Full______) == false) {
            return false;
        }
        Full______ rhs = ((Full______) other);

...
public class IngredientsEn implements Serializable
{
    ...
    @JsonProperty("sizes")
    private Sizes_______ sizes;
    private final static long serialVersionUID = -3658768732617653947L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public IngredientsEn() {
    }
     ...
     * @param geometry
     */
    public IngredientsEn(String imgid, String normalize, String geometry, String rev, Object whiteMagic, Sizes_______ sizes) {
        super();
        this.imgid = imgid;
    ...
    @JsonProperty("sizes")
    public Sizes_______ getSizes() {
        return sizes;
    }

    @JsonProperty("sizes")
    public void setSizes(Sizes_______ sizes) {
        this.sizes = sizes;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof IngredientsEn) == false) {
            return false;
        }
        IngredientsEn rhs = ((IngredientsEn) other);

...
public class Nutrition implements Serializable
{
    ...
    @JsonProperty("rev")
    private String rev;
    private final static long serialVersionUID = -6493303548306108383L;
     ...
     * @param geometry
     */
    public Nutrition(Sizes_____ sizes, String imgid, String normalize, String geometry, Object whiteMagic, String rev) {
        super();
        this.sizes = sizes;
        this.imgid = imgid;
    ...
    @JsonProperty("sizes")
    public Sizes_____ getSizes() {
        return sizes;
    }

    @JsonProperty("sizes")
    public void setSizes(Sizes_____ sizes) {
        this.sizes = sizes;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Nutrition) == false) {
            return false;
        }
        Nutrition rhs = ((Nutrition) other);

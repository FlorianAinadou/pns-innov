...
public class Full_______ implements Serializable
{
    ...
    @JsonProperty("w")
    private Long w;
    private final static long serialVersionUID = -735230360083401275L;
     ...
     * @param h
     */
    public Full_______(Long h, Long w) {
        super();
        this.h = h;
        this.w = w;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Full_______) == false) {
            return false;
        }
        Full_______ rhs = ((Full_______) other);

...
public class Full_ implements Serializable
{
    ...
    @JsonProperty("w")
    private Long w;
    private final static long serialVersionUID = 3503414017455510226L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Full_) == false) {
            return false;
        }
        Full_ rhs = ((Full_) other);

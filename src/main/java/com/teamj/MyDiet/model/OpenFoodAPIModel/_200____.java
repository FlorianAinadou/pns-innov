...
public class _200____ implements Serializable
{
    ...
    @JsonProperty("h")
    private Long h;
    private final static long serialVersionUID = 6152659390688862759L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _200____) == false) {
            return false;
        }
        _200____ rhs = ((_200____) other);

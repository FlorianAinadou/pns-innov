...
public class _100____ implements Serializable
{
    ...
    @JsonProperty("w")
    private Long w;
    private final static long serialVersionUID = 6249880848488973162L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _100____) == false) {
            return false;
        }
        _100____ rhs = ((_100____) other);

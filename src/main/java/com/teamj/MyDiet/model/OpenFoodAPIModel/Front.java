...
public class Front implements Serializable
{
    ...
    private final static long serialVersionUID = -7673833094096472169L;
     ...
     * @param geometry
     */
    public Front(Sizes_________ sizes, String rev, String geometry, Object whiteMagic, String imgid, Object normalize) {
        super();
        this.sizes = sizes;
        this.rev = rev;
    ...
    @JsonProperty("sizes")
    public Sizes_________ getSizes() {
        return sizes;
    }

    @JsonProperty("sizes")
    public void setSizes(Sizes_________ sizes) {
        this.sizes = sizes;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Front) == false) {
            return false;
        }
        Front rhs = ((Front) other);

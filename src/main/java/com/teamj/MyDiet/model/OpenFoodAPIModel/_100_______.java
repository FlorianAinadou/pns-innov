...
public class _100_______ implements Serializable
{
    ...
    @JsonProperty("h")
    private Long h;
    private final static long serialVersionUID = 4902117675489260174L;
     ...
     * @param h
     */
    public _100_______(Long w, Long h) {
        super();
        this.w = w;
        this.h = h;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _100_______) == false) {
            return false;
        }
        _100_______ rhs = ((_100_______) other);

...
public class _400________ implements Serializable
{
    ...
    @JsonProperty("w")
    private Long w;
    private final static long serialVersionUID = -7889147042845272307L;
     ...
     * @param h
     */
    public _400________(Long h, Long w) {
        super();
        this.h = h;
        this.w = w;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _400________) == false) {
            return false;
        }
        _400________ rhs = ((_400________) other);

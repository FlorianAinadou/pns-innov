...
public class Small__ implements Serializable
{

    @JsonProperty("en")
    private String en;
    private final static long serialVersionUID = 5007740956813679692L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Small__) == false) {
            return false;
        }
        Small__ rhs = ((Small__) other);

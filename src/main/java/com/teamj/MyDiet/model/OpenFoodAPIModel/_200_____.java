...
public class _200_____ implements Serializable
{
    ...
    @JsonProperty("w")
    private Long w;
    private final static long serialVersionUID = 6425604165213420159L;
     ...
     * @param h
     */
    public _200_____(Long h, Long w) {
        super();
        this.h = h;
        this.w = w;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _200_____) == false) {
            return false;
        }
        _200_____ rhs = ((_200_____) other);

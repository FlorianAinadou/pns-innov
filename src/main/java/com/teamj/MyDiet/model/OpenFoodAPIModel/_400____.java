...
public class _400____ implements Serializable
{
    ...
    @JsonProperty("h")
    private Long h;
    private final static long serialVersionUID = -7942548254750715647L;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _400____) == false) {
            return false;
        }
        _400____ rhs = ((_400____) other);
